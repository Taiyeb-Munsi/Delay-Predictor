...
def predict():
    ...
    weather_map = {'clear': 1.0, 'light rain': 1.15, 'heavy rain': 1.35, 'snow': 1.65}
    ...
    vehicle_max_speed = {'bike': 25, 'car': 90, 'truck': 60}
    ...
    if delay_ratio >= 1.5:
        status, color = 'HEAVY DELAY', '#e74c3c'
    elif delay_ratio >= 1.2:
        status, color = 'MODERATE DELAY', '#f39c12'
    elif delay_ratio >= 1.05:
        status, color = 'MINOR DELAY', '#f1c40f'
    else:
        status, color = 'CLEAR PATH', '#27ae60'
